...
import { Select, SelectContent, SelectValue } from "@cs-magic/shadcn/dist/ui/select"
...
export const SelectScenario = () => {
  ...
  return (
    <Select value={type} onValueChange={(s) => setType(s as ScenarioType)}>
      ...
      <SelectContent>
        <SelectModel value={"text2text"} Cover={Text2TextAppSVG} label={"文生文"} />
        <SelectModel value={"text2image"} Cover={Text2ImageAppSVG} label={"文生图"} />
      </SelectContent>
    </Select>
  )
}
