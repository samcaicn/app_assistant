...
export const cardLlmEnabledAtom = atomWithStorage<boolean>("card.llm.enabled", true)
export const cardLlmModelTypeAtom = atomWithStorage<LlmModelType>(
  "card.summary.model",
  "gpt-3.5-turbo", // gpt-3.5-turbo
)
export const cardSummaryWithImageAtom = atomWithStorage<boolean>("card.summary.with-image", false)
