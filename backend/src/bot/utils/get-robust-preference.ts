...
import { IWechatData, IWechatPreference, defaultWechatData, defaultWechatPreference } from "../../schema/index.js"
...
export const getRobustPreference = (
  ...
  // migrate
  const rawPreference = omit(parseJsonSafe<IWechatPreference>(row?.preference), [
    "chatterEnabled",
    "parserEnabled",
    "model",
    "lang",
